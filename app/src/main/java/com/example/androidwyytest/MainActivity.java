package com.example.androidwyytest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NIMClient.getService(AuthService.class).login(new LoginInfo("whsgzcy02", "whsgzcy520"))
                        .setCallback(new RequestCallback() {
                            @Override
                            public void onSuccess(Object param) {
                                Log.e("twc", param.toString());
                                NimUIKit.loginSuccess("whsgzcy02");
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 打开单聊界面
                NimUIKit.startP2PSession(MainActivity.this, "whsgzcy01", null);
